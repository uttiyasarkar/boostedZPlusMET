...
gStyle->SetOptTitle(0);  
  ...
  data2017Tree=(TTree*)inputFile->Get("data2017");
////////TH1 candidates 
  ...
  TH1D*PrunedMassdata=new TH1D("PrunedMassdata","Pruned Mass [GeV]", 50.,50.,200.);
  TH1D*PrunedMassdata2017=new TH1D("PrunedMassdata2017","Pruned Mass [GeV]", 50.,50.,200.);
  ...
  PrunedMassdata->Sumw2(kTRUE);
  PrunedMassdata2017->Sumw2(kTRUE);
  ...
  dataTree->Draw("PrunedMass1>>PrunedMassdata", "(MET>300 && HT>500 && JetPt1>300 && JetPt2>200 && PrunedMass1>50 && PrunedMass1<200 && PrunedMass2>70 && PrunedMass2<100)");  
  data2017Tree->Draw("PrunedMass1>>PrunedMassdata2017", "(MET>300 && HT>500 && JetPt1>300 && JetPt2>200 && PrunedMass1>50 && PrunedMass1<200 && PrunedMass2>70 && PrunedMass2<100)");  
  
  PrunedMassdata2017->Add(PrunedMassdata);
  ...
  RooDataHist data("data","data",jetMass,Import(*PrunedMassdata2017));
...
//  RooRealVar a2("a2","a2",0.023);
  ...
  RooFitResult *r =  bkg.fitTo(data,Range("Sideband1,Sideband2"),Save());
...
//  RooRealVar cheby1sigfrac("polyfrac","fraction of chebhchev",0.5,0.,1.0);
  ...
  cout << "***************************************************************************************************************************************************************************************************************************8 Bkg Integral "<< BkginSR->getVal()*PrunedMassdata2017->Integral() << endl ;
