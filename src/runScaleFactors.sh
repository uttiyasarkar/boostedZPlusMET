...
hadd -f ~/eos/boostedZPlusMET/$COMMIT/ALPHABEThistos_singleLep.root ~/eos/boostedZPlusMET/$COMMIT/ALPHABEThistos_singleEle.root ~/eos/boostedZPlusMET/$COMMIT/ALPHABEThistos_singleMu.root
hadd -f ~/eos/boostedZPlusMET/$COMMIT/ALPHABEThistos_looseCuts_singleLep.root ~/eos/boostedZPlusMET/$COMMIT/ALPHABEThistos_looseCuts_singleEle.root ~/eos/boostedZPlusMET/$COMMIT/ALPHABEThistos_looseCuts_singleMu.root
